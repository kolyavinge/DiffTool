...
internal class TextTest
{
    ...
    public void GetRange()
    {
        ...
        Assert.That(result.Lines[0].AsString(), Is.EqualTo("line1"));
        Assert.That(result.Lines[1].AsString(), Is.EqualTo("line2"));
        Assert.That(result.Lines[2].AsString(), Is.EqualTo("line3"));
    }
    ...
    public void GetRange_TwoLast()
    {
        ...
        Assert.That(result.Lines[0].AsString(), Is.EqualTo("line2"));
        Assert.That(result.Lines[1].AsString(), Is.EqualTo("line3"));
    }
    ...
    public void GetRange_Last()
    {
        ...
        Assert.That(result.Lines, Has.Count.EqualTo(1));
        Assert.That(result.Lines[0].AsString(), Is.EqualTo("line3"));
    }
}
